...
// Стандартные виды: направление от модели к камере; ось «вверх» камеры — Z, поэтому у видов вдоль Z малый сдвиг.
// Номера 0–3 — прежние (сохранены в файлах вида), 4–6 — противоположные стороны.
const VIEWS = [['изометрия', [0.55, -0.75, 0.45]], ['сверху (+Z)', [0.0001, -0.0001, 1]], ['спереди (−Y)', [0, -1, 0.0001]],
  ['справа (+X)', [1, 0, 0.0001]], ['снизу (−Z)', [0.0001, -0.0001, -1]], ['сзади (+Y)', [0, 1, 0.0001]], ['слева (−X)', [-1, 0, 0.0001]]];
...
export class Viewer3D {
  ...
  // Стандартный вид по номеру (VIEWS): 0 — изометрия, 1 — сверху, 2 — спереди, 3 — справа, 4 — снизу, 5 — сзади,
  // 6 — слева; возвращает его название.
  setView(i) {
